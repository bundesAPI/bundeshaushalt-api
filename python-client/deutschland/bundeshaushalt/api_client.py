...
from deutschland.bundeshaushalt import rest
...
from deutschland.bundeshaushalt.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BudgetDataApi()
        api_instance.budget_data  # this is an instance of the class Endpoint
        api_instance.budget_data()  # this invokes api_instance.budget_data.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.budget_data.callable or self.callable in this class
